...
public class Retirement {
	...
	public double MonthlySavings() {
		...
		double pmt = PMT(dAnnualReturnWorking / (double)12, 12 * iYearsToWork, 0, TotalAmountToSave(), false);
		return pmt;
	}

	public double TotalAmountToSave() {
		
		double pv = PV(dAnnualReturnRetired / (double)12, 12 * iYearsRetired, dRequiredIncome - dMonthlySSI, 0, false);
        return pv;
	}
